...
The research in this proposal lies at the interface between
neuroscience and data science. The underlying theme is to develop
...
new mathematical frameworks for data analysis.  The research
