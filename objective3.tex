...
We will study mathematical formulations of attention as one approach to making
...
locally sparse or ``focused'' representation is intended to make learning statistically and computationally tractable. Such a notion appears in the machine learning literature in different forms. 
...
Recall from above that an exponential family
