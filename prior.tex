...
Research on deformation theory of hyperbolic 3-manifolds, renormalized volume, and Teichm\"uller geometry appeared in \citep{BMNS:bounded:models,Brock:Bromberg:vol,Brock:Bromberg:cone:inflex,BLMR:wp:limit,BLMR:teichmuller}. Results included sufficient conditions for bounded geometry, a new direct relation of Weil-Petersson distance and volume, and complex limits of rays in Teichm\"uller space.
The paper \citep{Brock:Dunfield:norms} relates the Thurston norm and the {\em harmonic norm} on the cohomology of   hyperbolic 3-manifolds. The paper \citep{Keshavamurthy:TBI} adapted machine learning methods to auto detect CT-identifiable TBI lesions.
