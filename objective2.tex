...
machine learning methodology, used to represent
...
on statistical models, for instance based on exponential family
...
different underlying conditional distributions. We will use
this framework to develop more advanced and useful embedding
algorithms, inspired by our knowledge of higher-level cognition.
...
for representing data, using brain function as a inspiration
and as a rough metaphor for encoding data. For instance,
...
the frontotemporal cortext. Steps in such directions, have
arguably made in recent work \citep{replearn}. The framework of exponential family 
embeddings and variational inference provide powerful tools
