...
\def\msection#1{\vskip25pt\stepcounter{proposal}\setcounter{subproposal}{0}\noindent
   {\bf\Large \arabic{proposal}.\enspace #1}\vskip1pt\noindent}
...
\bibliography{3podx,3podx-clark,3podx-representation,jdl-previous,vision,hippocampus,prior-ntb,attention,memory,capacity,JFB}
